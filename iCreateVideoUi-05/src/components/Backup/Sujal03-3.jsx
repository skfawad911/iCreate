...
import doc from "../components/assets/doctor.jpg";
...
const Test = () => {
  ...
  console.log("T1", inputText1);
  console.log("T2", inputText2);
    ...
    if (
      ...
      recorder.onstop = async () => {
        ...
        try {
          ...
          // Ensure loader is hidden whether the request succeeds or fails
          setLoading(false);
        }
      };
            ...
            <div className="flex flex-col relative top-[-40px]">
              ...
              {selectedGroup === "group1" && (
                <div className="w-[335px] border-4 relative sm:w-[50vw] sm:left-[-200px] ">
                  ...
                  <input
                    type="text"
                    className="w-[96%] mb-[10px] h-[40px] sm:top-[10px] border-2 rounded-xl p-[10px] relative left-[9px]"
                    value={inputText1}
              ...
              {selectedGroup === "group2" && (
                <div className="w-[335px] border-4 relative sm:w-[50vw] sm:left-[-200px] ">
                        ...
                        {videoRef.current && (
                          <video ref={videoRef1} controls width="380">
                            {videoRef.current && (
                              <source
                                src={
                                  binaryVideoData ? videoRef1.current?.src : ""
                                }
                                type="video/mp4"
                              />
                            )}
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 1 Name*</label>
                  </div>
                  <input
                    type="text"
                    ...
                    placeholder="Enter Doctor 1 Name"
                  />
                  <div className="text-sm text-gray-500 flex justify-end mr-[10px] relative sm:top-[20px]">
                    {remainingCharacters1} of {charLimit}
                  </div>
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 2 Name*</label>
                  </div>
                  <input
                    type="text"
              ...
              {selectedGroup === "group3" && (
                <div className="w-[335px] border-4 relative sm:w-[50vw] sm:left-[-200px]  ">
                      ...
                      <>
                        ...
                        {videoRef.current && (
                          <video ref={videoRef2} controls width="300">
                            <source
                              src={
                                binaryVideoData ? videoRef2.current?.src : ""
                              }
                              type="video/mp4"
                            />
                            Your browser does not support the video tag.
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 3 Name*</label>
                  </div>
                  <input
                    type="text"
              ...
              {selectedGroup === "group4" && (
                <div className="w-[335px] border-4 relative sm:w-[50vw] sm:left-[-200px]  ">
                      ...
                      <>
                        ...
                        {videoRef.current && (
                          <video ref={videoRef3} controls width="350">
                            <source
                              src={
                                binaryVideoData ? videoRef3.current?.src : ""
                              }
                              type="video/mp4"
                            />
                            Your browser does not support the video tag.
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 4 Name*</label>
                  </div>
                  <input
                    type="text"
                    className="w-[96%] mb-[10px] h-[40px] border-2 rounded-xl p-[10px] relative left-[9px]  sm:top-[25px] "
              ...
              {selectedGroup === "group5" && (
                <div className="w-[335px] border-4 relative sm:w-[50vw] sm:left-[-200px] ">
                      ...
                      <>
                        ...
                        {videoRef.current && (
                          <video ref={videoRef4} controls width="380">
                            <source
                              src={
                                binaryVideoData ? videoRef4.current?.src : ""
                              }
                              type="video/mp4"
                            />
                            Your browser does not support the video tag.
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 5 Name*</label>
                  </div>
                  <input
                    type="text"
                    className="w-[96%] mb-[10px] h-[40px] border-2 rounded-xl p-[10px]  relative left-[9px]  sm:top-[25px] "
              ...
              {selectedGroup === "group6" && (
                <div className="w-[335px] border-4  relative sm:w-[50vw] sm:left-[-200px]   ">
                      ...
                      <>
                        ...
                        {videoRef.current && (
                          <video ref={videoRef5} controls width="240">
                            <source
                              src={
                                binaryVideoData ? videoRef5.current?.src : ""
                              }
                              type="video/mp4"
                            />
                            Your browser does not support the video tag.
                  ...
                  <div className="w-[300px]  relative sm:left-[20px] left-[10px] sm:top-[10px] text-left">
                    <label className="">Doctor 6 Name*</label>
                  </div>
                  <input
                    type="text"
                    className="w-[96%] mb-[10px] h-[40px] border-2 rounded-xl p-[10px] relative left-[9px]  sm:top-[25px]"

...
const Test = () => {
  ...
  const downloadWithWatermark1 = async () => {
    ...
    if (
      ...
      (inputText3 === "" || inputText2 === "" || inputText1 === "" || isButtonDisabled === false)
    ) {
      failed();
    } else if (
    ...
    <>
     ...
     <div className="w-[99vw]"> 
      ...
      <div className="flex flex-row justify-between items-center relative top-[-8px] ">
        <NavLink className="p-5 flex relative left-[-36px] " to={`/home/${MRID}`}>
          <div
      ...
      <div className="flex flex-col relative top-[-40px]">
        ...
        {selectedGroup === "group1" && (
          <div className="w-[94vw] border-4 relative left-[10px] ">
        ...
        className={` ${
          isButtonDisabled ? 'bg-gray-400 cursor-not-allowed text-black mt-[20px] rounded-md transition duration-300 w-full h-[30px]' : 'bg-yellow-500  text-black mt-[20px] rounded-md transition duration-300 w-full h-[30px]'
        }`}
      ...
      >
        ...
        {selectedGroup === "group2" && (
          <div className="w-[94vw] border-4 relative left-[10px] ">
            ...
            <label className="relative left-[13px] text-[15px]">
              Doctor 2 Name*
            </label>
            <input
              type="text"

...
const Template1 = () => {
  ...
  //     // Change button color to a different color (e.g., red) when clicked
  //     setbuttonText("Image Added");
  ...
  const handleUserData = (inputText) => {
    ...
    fetch(` http://test-alb-1277038718.ap-south-1.elb.amazonaws.com:8050/api/auth/submitUsage/${mrId}`, {
      method: "POST",
      headers: {
    ...
    mediaRecorder.onstop = async () => {
      ...
      try {
        const response = await fetch(
          " http://test-alb-1277038718.ap-south-1.elb.amazonaws.com:8050/api/auth/videoCon",
          {
            method: "POST",
            body: formData,
          }
  ...
  useEffect(() => {
    axios
      .get(` http://test-alb-1277038718.ap-south-1.elb.amazonaws.com:8050/${videoname}`, {
  ...
  return (
    <>
      <div className="flex justify-center items-center flex-col ">
        ...
        <div className="absolute top-[70px] w-[335px] ">
          ...
          <div className="w-screen h-auto  mx-auto p-8 text-center flex justify-center items-center relative top-[-27px]">
            <div className=" w-[94vw] border-4 relative left-[-22px] top-[-29px] ">
              <Modal
                isOpen={modalIsOpen}
              ...
              <select
                ...
                className=" px-4 py-2  relative  w-[85vw] border   border-gray-300 rounded-md focus:outline-none focus:border-blue-500 bg-white text-gray-800 hover:shadow-md transition duration-300"
              >
        ...
        <option value="group6">Number of Doctors 6</option> */}
              ...
              {selectedGroup === "group1" && (
                <div className="w-full relative  ">
                  <label className="relative left-[-93px] text-[15px] mt-[10px]">
                    Doctor 1 Name*
                  </label>
                  <input
                    type="text"
                    className="w-[96%] mb-[10px] h-[40px] border-2 rounded-xl p-[10px] relative "
                    value={inputText1}
                  ...
                  <button
                    onClick={openModal}
                    className="bg-[#e5e5e5] text-black  rounded-md  transition duration-300 w-full h-[30px]"
                  >
                    Crop
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="bg-green-500  text-white mt-[20px] rounded-md  w-full h-[30px]"
                  >
                    Download
                  </button>
                </div>
              ...
              {selectedGroup === "group2" && (
                <div className="w-full  relative  ">
                  ...
                  {groupInputs.group2.fileInputs.map((_, index) => (
                    <div
                  ...
                  <label className="relative  left-[-93px] text-[15px]">
                    Doctor 2 Name*
                  </label>
                  <input
                    type="text"
                  ...
                  <button
                    onClick={openModal}
                    className="bg-[#e5e5e5] text-black mt-[20px]   rounded-md  transition duration-300 w-full h-[30px]"
                  >
                    Crop
                  </button>
                  <button
              ...
              {selectedGroup === "group3" && (
                <div className="w-full  ">
                  ...
                  {groupInputs.group3.fileInputs.map((_, index) => (
                    <div
                      className="relative left-[10px]  mb-[10px]"
                      key={index}
                      style={{ display: "inline-block", marginRight: "10px" }}
              ...
              {selectedGroup === "group4" && (
                <div className="w-full ">
                  ...
                  <input
                    ...
                    placeholder="Enter Doctor 1 Name"
                  />
                  {groupInputs.group4.fileInputs.map((_, index) => (
                    <div
                      className="relative left-[10px]  mb-[10px]"
                      key={index}
                      style={{ display: "inline-block", marginRight: "10px" }}
                  ...
                  <button
                    onClick={openModal}
                    className="bg-[#ef8018] text-white   rounded-md  transition duration-300 w-full h-[30px]"
                  >
                    Crop
                  </button>
                  ...
                  <button
                    onClick={addWatermark}
                    className="bg-green-500 text-white   rounded-md hover:bg-green-600 transition duration-300 w-full h-[30px]"
                  >
                    Add Image
                  </button>
                  <ToastContainer />
                  <button
                    onClick={handleDownloadClick}
                    className="bg-[#ef8018] text-white  rounded-md  w-full h-[30px]"
                  >
                    Download
                  </button>
                </div>

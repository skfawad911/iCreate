...
const Template1 = () => {
  ...
  const handleUserData = (inputText) => {
    ...
    fetch(` http://test-alb-637128492.ap-south-1.elb.amazonaws.com:8050/api/auth/submitUsage/${mrId}`, {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    axios
      .get(` http://test-alb-637128492.ap-south-1.elb.amazonaws.com:8050/${videoname}`, {

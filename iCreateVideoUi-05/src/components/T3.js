...
const Test = () => {
  ...
  const [isLoadingVideo3, setIsLoadingVideo3] = useState(false);
  const [isLoadingVideo4, setIsLoadingVideo4] = useState(false);
  const [isLoadingVideo5, setIsLoadingVideo5] = useState(false);
  const [isLoadingVideo6, setIsLoadingVideo6] = useState(false);
  ...
  const handleUserData = (inputText) => {
    ...
    fetch(
      `  http://test-alb-1277038718.ap-south-1.elb.amazonaws.com:8050/api/auth/submitUsage/${mrId}`,
      {
        method: "POST",
        headers: {
      ...
      recorder.onstop = async () => {
        ...
        try {
          ...
          if (selectedGroup === "group2") {
            ...
            setTimeout(() => {
              downloadWithWatermark2();
            }, 13000); // 3 seconds in milliseconds
          } else if (selectedGroup === "group4") {
            setTimeout(() => {
              downloadWithWatermark2();
            }, 17000);
      ...
      recorder.onstop = async () => {
        ...
        try {
          ...
          if (selectedGroup === "group3") {
            ...
            }, 18000); // 60 seconds in milliseconds
          } else if (selectedGroup === "group4") {
            setTimeout(() => {
              downloadWithWatermark3();
            }, 24000);
    ...
    recorder.onstop = async () => {
      ...
      try {
        ...
        if (selectedGroup === "group5") {
          ...
          }, 24000); // 30 seconds in milliseconds
        } else if (selectedGroup === "group6") {
          setTimeout(() => {
            downloadWithWatermark5();
          }, 35000);
    ...
    recorder.onstop = async () => {
      ...
      try {
        ...
        if (selectedGroup === "group6") {
          ...
          }, 41000); // 30 seconds in milliseconds
  ...
  useEffect(() => {
    if (
      ...
      axios
        .get(
          `  http://test-alb-1277038718.ap-south-1.elb.amazonaws.com:8050/${videoname}`,
          {
            responseType: "arraybuffer",
          }
        )
        ...
        <div className="absolute top-[34px] w-[335px]  sm:w-[750px] xl:left-[450px] sm:left-[265px] ">
          <div className=" w-full">
            <div className="flex flex-row justify-between items-center relative top-[-8px] ">
              ...
              <div className="text-black text-[20px] font-bold relative left-[-133px] sm:left-[-335px] top-[-2px]  ">
                <p>Birthday</p>
              </div>
            </div>

  ...
  return (
    ...
    <div className="flex justify-center relative top-[50px] ">
      ...
      <div className="absolute w-[360px] h-[1040px] xl:w-[74vw] sm:w-[84vw] overflow-x-hidden ">
        ...
        <div className="  ">
          <div className="absolute  left-[102px] top-[40px] text-[#ef8018]  h-[31px] text-left font-bold text-[23px] sm:text-[45px] sm:left-[399px]">
...
<div className="w-full">
        <div className=" mt-[10px]  gap-10 grid grid-cols-2 sm:grid-cols-3 text-[9px] relative top-[85px] lg:top-[120px] sm:top-[185px] sm:left-[200px]   sm:w-[800px]">
          ...
          <>
            ...
            <div className="flex flex-col ">
              {/* // dropdown 1  */}
              <div className="relative top-[161px] sm:top-[288px] sm:left-[-548px] left-[20px] w-[80vw] sm:w-[54vw] xl:w-[42vw] h-[50px] border-2 border-black rounded-full">
                <nav class="flex-1">
              ...
              <div className={`relative top-[178px]  sm:top-[310px]  sm:left-[-548px] left-[20px] w-[80vw]  sm:w-[54vw] xl:w-[42vw] h-[50px] border-2 border-black rounded-full ${isMenuChecked2 ? 'mt-[500px]' : ''}`}>
                <nav class="flex-1">
                  <div class="relative transition">
                    <input
                      class="peer hidden"

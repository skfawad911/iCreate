	...
	return (
		<div className='container'>
			<div className='container-cropper'>
				{image ? (
					<>
						...
						<div className='slider sm:w-[430px] relative sm:left-[120px] xl:left-[350px]'>
							<Slider
								min={1}
								max={3}
								step={0.1}
			...
			<div className='container-buttons'>
				...
				<div className=" sm:relative sm:left-[10px] sm:top-[10px] xl:top-[-10px]  flex justify-center items-center"> 

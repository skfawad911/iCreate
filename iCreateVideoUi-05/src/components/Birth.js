const downloadWithWatermark1 = async () => {
    ...
    const recorder = new MediaRecorder(new MediaStream([videoStream.getVideoTracks()[0], audioStream.getAudioTracks()[0]]), {
        mimeType: 'video/webm'
    });
    const chunks = [];
        ...
        if (showWatermark && watermarkImageObjects && watermarkImageObjects.length > 0) {
            ...
            if (elapsedTime <= holdImageUntilTime && holdImageUntilTime > 0) {
                ...
                if (elapsedTime <= 16 + moveDuration) {
                    ...
                    // Draw watermark 2 from bottom-left
                    ctx.drawImage(watermarkImageObjects[5], 50, currentY, watermarkSize, watermarkSize);
                    ...
                    // Draw watermark 3 from bottom-middle with easing
                    ctx.drawImage(watermarkImageObjects[6], watermark3X, currentY3, watermarkSize, watermarkSize);

                    // Draw watermark 4 from bottom-right with easing
                    ctx.drawImage(watermarkImageObjects[7], watermark4X, currentY4, watermarkSize, watermarkSize);
                } else {
                    // Code to execute after the upward movement phase (when watermark 3 and 4 should hold their position)
                    // Draw watermark 2 at the top left
                    ctx.drawImage(watermarkImageObjects[5], 50, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 3 at the hold position
                    const watermark3X = canvas.width / 2 - watermarkSize / 2;
                    ctx.drawImage(watermarkImageObjects[6], watermark3X, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 4 at the hold position
                    const watermark4X = canvas.width - watermarkSize - 50;
                    ctx.drawImage(watermarkImageObjects[7], watermark4X, canvas.height - 400, watermarkSize, watermarkSize);
                    ...
                    // Apply pulsing effect to watermark 2
                    ctx.drawImage(watermarkImageObjects[5], 50, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 3
                    ctx.drawImage(watermarkImageObjects[6], watermark3X, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 4
                    ctx.drawImage(watermarkImageObjects[7], watermark4X, canvas.height - 400, watermarkWidth, watermarkHeight);
                }
            } else if (elapsedTime > 23) {
                // Display the watermark at the bottom-left with bottom margin
                const watermarkPosition = { x: 60, y: canvas.height - 130 }; // Updated y position to move upward by 20 pixels
        ...
        if (showWatermark && watermarkImageObjects && watermarkImageObjects.length > 0) {
            ...
            if (elapsedTime <= holdImageUntilTime && holdImageUntilTime > 0) {
                ...
                if (elapsedTime <= 16 + moveDuration) {
                    ...
                    // Draw watermark 2 from bottom-left
                    ctx.drawImage(watermarkImageObjects[9], 50, currentY, watermarkSize, watermarkSize);
                    ...
                    // Draw watermark 3 from bottom-middle with easing
                    ctx.drawImage(watermarkImageObjects[10], watermark3X, currentY3, watermarkSize, watermarkSize);

                    // Draw watermark 4 from bottom-right with easing
                    ctx.drawImage(watermarkImageObjects[11], watermark4X, currentY4, watermarkSize, watermarkSize);
                } else {
                    // Code to execute after the upward movement phase (when watermark 3 and 4 should hold their position)
                    // Draw watermark 2 at the top left
                    ctx.drawImage(watermarkImageObjects[9], 50, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 3 at the hold position
                    const watermark3X = canvas.width / 2 - watermarkSize / 2;
                    ctx.drawImage(watermarkImageObjects[10], watermark3X, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 4 at the hold position
                    const watermark4X = canvas.width - watermarkSize - 50;
                    ctx.drawImage(watermarkImageObjects[11], watermark4X, canvas.height - 400, watermarkSize, watermarkSize);
                    ...
                    // Apply pulsing effect to watermark 2
                    ctx.drawImage(watermarkImageObjects[9], 50, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 3
                    ctx.drawImage(watermarkImageObjects[10], watermark3X, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 4
                    ctx.drawImage(watermarkImageObjects[11], watermark4X, canvas.height - 400, watermarkWidth, watermarkHeight);
                }
            } else if (elapsedTime > 23) {
                // Display the watermark at the bottom-left with bottom margin
                const watermarkPosition = { x: 60, y: canvas.height - 130 }; // Updated y position to move upward by 20 pixels
        ...
        if (showWatermark && watermarkImageObjects && watermarkImageObjects.length > 0) {
            ...
            if (elapsedTime <= holdImageUntilTime && holdImageUntilTime > 0) {
                ...
                if (elapsedTime <= 16 + moveDuration) {
                    ...
                    // Draw watermark 2 from bottom-left
                    ctx.drawImage(watermarkImageObjects[13], 50, currentY, watermarkSize, watermarkSize);
                    ...
                    // Draw watermark 3 from bottom-middle with easing
                    ctx.drawImage(watermarkImageObjects[14], watermark3X, currentY3, watermarkSize, watermarkSize);

                    // Draw watermark 4 from bottom-right with easing
                    ctx.drawImage(watermarkImageObjects[15], watermark4X, currentY4, watermarkSize, watermarkSize);
                } else {
                    // Code to execute after the upward movement phase (when watermark 3 and 4 should hold their position)
                    // Draw watermark 2 at the top left
                    ctx.drawImage(watermarkImageObjects[13], 50, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 3 at the hold position
                    const watermark3X = canvas.width / 2 - watermarkSize / 2;
                    ctx.drawImage(watermarkImageObjects[14], watermark3X, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 4 at the hold position
                    const watermark4X = canvas.width - watermarkSize - 50;
                    ctx.drawImage(watermarkImageObjects[15], watermark4X, canvas.height - 400, watermarkSize, watermarkSize);
                    ...
                    // Apply pulsing effect to watermark 2
                    ctx.drawImage(watermarkImageObjects[13], 50, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 3
                    ctx.drawImage(watermarkImageObjects[14], watermark3X, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 4
                    ctx.drawImage(watermarkImageObjects[15], watermark4X, canvas.height - 400, watermarkWidth, watermarkHeight);
                }
            } else if (elapsedTime > 23) {
                // Display the watermark at the bottom-left with bottom margin
                const watermarkPosition = { x: 60, y: canvas.height - 130 }; // Updated y position to move upward by 20 pixels
        ...
        if (showWatermark && watermarkImageObjects && watermarkImageObjects.length > 0) {
            ...
            if (elapsedTime <= holdImageUntilTime && holdImageUntilTime > 0) {
                ...
                if (elapsedTime <= 16 + moveDuration) {
                    ...
                    // Draw watermark 2 from bottom-left
                    ctx.drawImage(watermarkImageObjects[17], 50, currentY, watermarkSize, watermarkSize);
                    ...
                    // Draw watermark 3 from bottom-middle with easing
                    ctx.drawImage(watermarkImageObjects[18], watermark3X, currentY3, watermarkSize, watermarkSize);

                    // Draw watermark 4 from bottom-right with easing
                    ctx.drawImage(watermarkImageObjects[19], watermark4X, currentY4, watermarkSize, watermarkSize);
                } else {
                    // Code to execute after the upward movement phase (when watermark 3 and 4 should hold their position)
                    // Draw watermark 2 at the top left
                    ctx.drawImage(watermarkImageObjects[17], 50, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 3 at the hold position
                    const watermark3X = canvas.width / 2 - watermarkSize / 2;
                    ctx.drawImage(watermarkImageObjects[18], watermark3X, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 4 at the hold position
                    const watermark4X = canvas.width - watermarkSize - 50;
                    ctx.drawImage(watermarkImageObjects[19], watermark4X, canvas.height - 400, watermarkSize, watermarkSize);
                    ...
                    // Apply pulsing effect to watermark 2
                    ctx.drawImage(watermarkImageObjects[17], 50, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 3
                    ctx.drawImage(watermarkImageObjects[18], watermark3X, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 4
                    ctx.drawImage(watermarkImageObjects[19], watermark4X, canvas.height - 400, watermarkWidth, watermarkHeight);
                }
            } else if (elapsedTime > 23) {
                // Display the watermark at the bottom-left with bottom margin
                const watermarkPosition = { x: 60, y: canvas.height - 130 }; // Updated y position to move upward by 20 pixels
        ...
        if (showWatermark && watermarkImageObjects && watermarkImageObjects.length > 0) {
            ...
            if (elapsedTime <= holdImageUntilTime && holdImageUntilTime > 0) {
                ...
                if (elapsedTime <= 16 + moveDuration) {
                    ...
                    // Draw watermark 2 from bottom-left
                    ctx.drawImage(watermarkImageObjects[21], 50, currentY, watermarkSize, watermarkSize);
                    ...
                    // Draw watermark 3 from bottom-middle with easing
                    ctx.drawImage(watermarkImageObjects[22], watermark3X, currentY3, watermarkSize, watermarkSize);

                    // Draw watermark 4 from bottom-right with easing
                    ctx.drawImage(watermarkImageObjects[23], watermark4X, currentY4, watermarkSize, watermarkSize);
                } else {
                    // Code to execute after the upward movement phase (when watermark 3 and 4 should hold their position)
                    // Draw watermark 2 at the top left
                    ctx.drawImage(watermarkImageObjects[21], 50, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 3 at the hold position
                    const watermark3X = canvas.width / 2 - watermarkSize / 2;
                    ctx.drawImage(watermarkImageObjects[22], watermark3X, canvas.height - 400, watermarkSize, watermarkSize);

                    // Draw watermark 4 at the hold position
                    const watermark4X = canvas.width - watermarkSize - 50;
                    ctx.drawImage(watermarkImageObjects[23], watermark4X, canvas.height - 400, watermarkSize, watermarkSize);
                    ...
                    // Apply pulsing effect to watermark 2
                    ctx.drawImage(watermarkImageObjects[21], 50, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 3
                    ctx.drawImage(watermarkImageObjects[22], watermark3X, canvas.height - 400, watermarkWidth, watermarkHeight);

                    // Apply pulsing effect to watermark 4
                    ctx.drawImage(watermarkImageObjects[23], watermark4X, canvas.height - 400, watermarkWidth, watermarkHeight);
                }
            } else if (elapsedTime > 23) {
                // Display the watermark at the bottom-left with bottom margin
                const watermarkPosition = { x: 60, y: canvas.height - 130 }; // Updated y position to move upward by 20 pixels
